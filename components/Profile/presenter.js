    ...
    >
      <View style={styles.profile}>
        <View style={styles.header}>
          <TouchableOpacity onPress={props.showAS}>
            <Image
              source={
          ...
          <View style={styles.headerColumn}>
            <View style={styles.profileNumbers}>
              <ProfileNumber number={props.profileObject.post_count} text={'posts'} />
              <ProfileNumber number={props.profileObject.followers_count} text={'followers'} />
              <ProfileNumber number={props.profileObject.following_count} text={'following'} />
            </View>
        ...
        <View style={styles.modeBar}>
          <TouchableOpacity onPress={props.changeToGrid}>
          ...
          <TouchableOpacity onPress={props.changeToList}>
            <View style={styles.modeIcon}>
              <Ionicons
                name={'ios-list'}
                size={38}
        ...
        {props.mode === 'list' &&
          props.profileObject.images &&
          props.profileObject.images.map(photo => <Photo {...photo} key={photo.id} />)}
      </View>
    </ScrollView>
  </View>
)
